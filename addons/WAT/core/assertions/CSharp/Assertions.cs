...
namespace WAT {
	...
	public class Assertions : Reference
	{
		...
		public void IsNull(object value, string context = "")
		{
			Output(Utility.IsNull(value, context));
		}

		public void IsNotNull(object value, string context = "")
		{
			Output(Utility.IsNotNull(value, context));
		}
